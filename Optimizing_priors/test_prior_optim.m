...
param2optim{1}.theta.mu.ind = [1];
param2optim{1}.theta.mu.step = 1;
param2optim{1}.theta.mu.bounds = [-10,10];

param2optim{1}.theta.s.ind = [1];
param2optim{1}.theta.s.step = 1;
param2optim{1}.theta.s.bounds = [-10,10];

param2optim{1}.phi.mu.ind = [1];
param2optim{1}.phi.mu.step = 1;
param2optim{1}.phi.mu.bounds = [-10,10];

param2optim{1}.phi.s.ind = [1];
param2optim{1}.phi.s.step = 1;
param2optim{1}.phi.s.bounds = [-10,10];
...
param2optim{2}.theta.mu.ind = [1:3];
param2optim{2}.theta.mu.step = [1,1,1];
param2optim{2}.theta.mu.bounds = [-10,10;
                                  -10,10;
                                  -10,10];

param2optim{2}.theta.s.ind = [1:3];
param2optim{2}.theta.s.step = [1,1,1];
param2optim{2}.theta.s.bounds = [-10,10;
                                  -10,10;
                                  -10,10];
                              
param2optim{2}.phi.mu.ind = [1];
param2optim{2}.phi.mu.step = 1;
param2optim{2}.phi.mu.bounds = [-10,10];
                              
param2optim{2}.phi.s.ind = [1];
param2optim{2}.phi.s.step = 1;
param2optim{2}.phi.s.bounds = [-10,10];
 
 optim_options.param2optim = param2optim;
