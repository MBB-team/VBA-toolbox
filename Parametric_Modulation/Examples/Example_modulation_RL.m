...
%----------------------------------------------------
% Summary of code:
% - creation of initial RL model
% - declaration of modulators and creation of modulated model 
% - launching inversions
...
% -- Simulate input
u = [zeros(2,Ntrials);... % first two lines left blank for now  (action/reward)
    randn(1,Ntrials); % modulatory input 1
    randn(1,Ntrials); % modulatory input 2
    ];
...
% -- Simulate data % RL model: 
% - learning rate alpha = 0.3, modulation by u(1) with linear parameter 0.1;
...
%%
[inversions,inv_order,p_m,LogEv] = VBA_Inversion_modulation(y,u,f_fname_m,g_fname_m,dim_m,options_m,mod);
