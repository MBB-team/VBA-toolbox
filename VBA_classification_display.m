...
title(all.handles.ha(1),'classifier test prediction','FontSize',12,'Color','r')
...
title(all.handles.ha(2),'test prediction accuracy','FontSize',12,'Color','r')

% display classifier confidence
iok = find(acc==1);
mvok = mean(Vg(iok));
vvok = var(Vg(iok));
inok = find(acc==0);
...
title(all.handles.ha(3),'test prediction doubt','FontSize',12,'Color','r')
...
title(all.handles.ha(4),'weights'' estimates','FontSize',12,'Color','r')
...
title(all.handles.ha(5),'classical inference','FontSize',12,'Color','r')
...
title(all.handles.ha(6),'Bayesian inference','FontSize',12,'Color','r')
