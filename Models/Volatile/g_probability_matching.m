...
% - P : Parameter of the utility function
% - u_t : []
% - in.u_fname: handle of the utility function
% OUTPUT
...
s1 = sqrt(x_t(2));
s2 = sqrt(x_t(4));
[du1,u1] = numericDiff(in.u_fname,1,mu1,P,in);
[du2,u2] = numericDiff(in.u_fname,1,mu2,P,in);
