function [] = demo_1DneuralField()

% [broken]
% This demo inverts a linear 1D neural field model observed through a
...
% dimensions
n_t             = 2e3;                      % number of time points
ns              = 8;                        % size of the square grid
deltat          = 2e-2;                     % time discretization
f_fname         = @f_1DneuralField;        % Evolution function
