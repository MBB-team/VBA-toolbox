function [posterior,out,y] = demo_mixed_data()
%%% ----------------------------------------------------------------------
...
g_fname = @g_demo_mixed_data;  % observation function (multiple sources)

TR = 2e0;                     % sampling period (in sec)
n_t = round(410/TR);          % number of time samples
