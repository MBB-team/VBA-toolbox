...
The distribution under the null $$p\left(t \mid H_0 \right)$$ is shown in red, along with the probability of finding a more extreme value under the null $$P\left(t>t^\ast \mid H_0 \right)$$. Under this decision rule, we expect to wrongly accept the null in $$100 \times \alpha \%$$ cases.
