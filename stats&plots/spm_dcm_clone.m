function [DCM,err] = spm_dcm_clone(DCM0,VOIfnames,SPMfname,DCMfname,Unames,Ynames)
% clones an existing DCM structure and replaces appropriate data and inputs
% function [DCM] = spm_dcm_clone(DCM0,VOIfnames,SPMfname,DCMfname,Unames,Ynames)
% IN:
