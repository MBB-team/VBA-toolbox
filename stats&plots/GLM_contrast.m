...
title(handles.ha(5),'design matrix','fontsize',12,'fontweight','bold')
...
colormap(cool)
title(handles.ha(3),'parameters'' correlation matrix','fontsize',12,'fontweight','bold')
...
title(handles.ha(4),'constrast','fontsize',12,'fontweight','bold')
...
title(ha,'residuals'' normality','fontsize',12,'fontweight','bold')
xl = get(ha,'xlim');
yl = get(ha,'ylim');
...
title(ha,'residuals'' homoscedasticity','fontsize',12,'fontweight','bold')
try;getSubplots;end
...
title(ud.handles.ha(1),'data alignement','fontsize',12,'fontweight','bold')
...
title(ud.handles.ha(6),'data fit','fontsize',12,'fontweight','bold')
...
title(ud.handles.ha(2),'parameter estimates','fontsize',12,'fontweight','bold')
