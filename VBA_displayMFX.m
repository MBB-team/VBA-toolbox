...
if dim.n_phi > 0
    ...
    if ~isempty(indrfx)
        title(display.ha(1,1),'phi: population mean','fontsize',12,'fontweight','bold')
        cla(display.ha(1,2))
        ...
        title(display.ha(1,2),'phi: population log-precision','fontsize',12,'fontweight','bold')
    else
        title(display.ha(1,1),'phi: group mean (FFX)','fontsize',12,'fontweight','bold')
    end
end
if dim.n_theta > 0
    m = p_group.muTheta;
    ...
    if ~isempty(indrfx)
        title(display.ha(2,1),'theta: population mean','fontsize',12,'fontweight','bold')
        cla(display.ha(2,2))
        ...
        title(display.ha(2,2),'theta: population log-precision','fontsize',12,'fontweight','bold')
    else
        title(display.ha(2,1),'theta: group mean (FFX)','fontsize',12,'fontweight','bold')
    end
end
if dim.n >0
    m = p_group.muX0;
    ...
    if ~isempty(indrfx)
        title(display.ha(3,1),'x0: population mean','fontsize',12,'fontweight','bold')
        cla(display.ha(3,2))
        ...
        title(display.ha(3,2),'x0: population log-precision','fontsize',12,'fontweight','bold')
    else
        title(display.ha(3,1),'x0: group mean (FFX)','fontsize',12,'fontweight','bold')
    end
end
...
if o_group.it >= 1
    ...
    title(display.ha(4,1),'VB optimization: F values','fontsize',12,'fontweight','bold')
